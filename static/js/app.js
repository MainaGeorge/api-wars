...
document.getElementById('next').addEventListener('click', callback(nextUrl));
document.getElementById('prev').addEventListener('click', callback(prevUrl));
